  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <fieldset className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 bg-slate-100 p-1 rounded-xl" role="radiogroup" aria-label="Escolha do canal de notificação">
          {(['email', 'sms'] as NotificationChannel[]).map((channel) => (
            <button
              ...
              className={`py-2 text-xs font-semibold rounded-lg capitalize transition-all ${formValues.channel === channel

...
const SmsPayloadSchema = z.object({
  ...
  to: z.string().regex(/^\+[1-9]\d{7,14}$/, 'E.164 format is required').describe('The recipient phone number in E.164 format. Example: +5511999999999'),
...
export const EnqueueResultSchema = z.object({
  messageId: z.string().uuid().describe('The unique identifier for the queued notification. Example: 123e4567-e89b-12d3-a456-426614174000'),
...
export const CreateNotificationRouteSchema = {
  ...
  description: 'Validates and enqueues a new notification message (Email or SMS) for asynchronous processing via RabbitMQ.',

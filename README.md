...
3. [🏗️ Arquitetura do Sistema e Fluxo de Mensagens](#️-arquitetura-do-sistema-e-fluxo-de-mensagens)
4. [🛡️ Resiliência e Mensageria no RabbitMQ](#️-resiliência-e-mensageria-no-rabbitmq)
...
10. [🛠️ Ferramental de Desenvolvimento e Git Hooks](#️-ferramental-de-desenvolvimento-e-git-hooks)
